...
export default function Experience() {
  ...
  return (
    <div className='expbody absolute flex flex-row w-full h-[720vh] bg-[#404040] exp_page'>
    ...
    <div className='absolute w-[800px] h-32 transition-colors duration-500 shadow-2xl bg-teal-900/30 rounded-xl -left-2 firsti top-20 hover:bg-teal-950/40'>
      ...
      <p id='ue_text1' className='absolute text-5xl tracking-wider text-white font-break w-96 left-52 top-10'>UNREAL ENGINE</p>
    </div>
    </Fade>
      <h1 id='des' className='absolute h-48 font-fira font-bold text-2xl leading-10 top-72 right-32 w-[600px] text-white  '>"During my school days, I developed my own 3D game using <span className='text-yellow-200'>Unreal Engine 3</span> and have a good passion for Game Development."</h1>
      ...
      <div className='relative w-[600px] top-[480px] left-44 text-xl'>
        ...
        <div className=' absolute w-[900px] transition-colors duration-500 shadow-2xl top-[690px] right-[737px] bg-teal-900/30 rounded-xl secondi h-28 hover:bg-teal-950/40'>
           ...
           <p id='ue_text2' className='absolute  font-break tracking-wider text-5xl w-[900px] left-80 top-10 text-white'> FIGMA</p>
        </div>
        </Fade>
        <div className='relative w-[600px] p-10 top-[670px] right-0 text-black rounded-xl'>
       <p className='text-2xl font-bold leading-10 text-white font-fira sampletxt'>Food Ordering application project for the course provided by META via Coursera where i have learnt matching colors with the company specification, padding, fontography, font size, font padding, working with images, grids, Designing interactive components using auto layout and more.</p>
       </div>
       <div className='relative w-[600px] p-10 -bottom-[792px] text-black '>
       <p className='text-2xl font-bold text-white font-fira sampletxt'><span className='text-yellow-200'>Designing</span> part is very interesting as it makes you think of all the possible color, font, padding, border, margin, rounded edges, usage of svgs, shapes... combinations which could affect the appearance of a site drastically.</p>
       </div>
       <Fade left duration={1000}>
        <div className='relative w-[815px] transition-colors duration-500 shadow-2xl  top-[1150px] right-[950px] bg-teal-900/30 rounded-xl secondi h-28 hover:bg-teal-950/40'>
           ...
           <p id='ue_text2' className='absolute  font-break tracking-wider  text-5xl w-[900px] left-60 top-10 text-white'>  BLENDER</p>
        </div>
        </Fade>
        <div className='absolute top-[2600px] flex flex-col space-y-48'>
          ...
          <p className='relative mt-2 text-2xl font-bold font-fira sampletxt'>
            Iam a little familiar with modelling ,camera angles , animation and rigging in <span className='text-yellow-200'> Blender</span>
          </p>
          </div>
        </div>
        <Fade left duration={1000}>
        <div className='reactslide relative w-[815px] transition-colors duration-500 shadow-2xl  top-[2150px] right-[950px] bg-teal-900/30 rounded-xl secondi h-28 hover:bg-teal-950/40'>
           ...
           <p id='ue_text2' className='absolute  font-break tracking-wider  text-5xl w-[900px] left-60 top-10 text-white'>  REACT</p>
        </div>
        </Fade>
        ...
        <div className='relative top-[2490px] right-[885px] h-[800px] w-screen flex flex-row '>
          ...
          <p className='relative mt-2 text-2xl font-bold text-white font-fira sampletxt'>
          ...
          <div className='relative w-[607px] p-10 left-32  h-[300px]'>
          <p className='relative mt-2 text-2xl font-bold text-white font-fira sampletxt'>
            This portfolio website itself is the first <span className='text-yellow-200'>React</span> project Im currently working on. As i gain knowledge about new techniques i will update the portfolio.The best thing about <span className='text-yellow-200'>React</span> is the option to reuse components
          </p>
          </div>
          </div>
        </div>
        ...
        <div className='relative w-[815px] transition-colors duration-500 shadow-2xl  top-[2800px] right-[950px] bg-teal-900/30 rounded-xl secondi h-28 hover:bg-teal-950/40'>
           ...
           <p id='ue_text2' className='absolute  font-break tracking-wider  text-5xl w-[900px] left-60 top-10 text-white'>  GITHUB , GIT</p>
        </div>
        </Fade>
        <div className='relative top-[3140px] right-[885px] h-[800px] w-screen flex flex-row '>
          ...
          <p className='relative mt-2 text-2xl font-bold font-fira sampletxt'>
            I have used <span className='text-yellow-200'>Github</span> many times in my previous projects and really like the fact that you can explore others project and understand the methodolody
          </p>
          </div>
